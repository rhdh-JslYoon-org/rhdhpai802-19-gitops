...
# Application
An application built from https://github.com/rhdh-JslYoon-org/rhdhpai802-19 will be stored in [quay.io/rh-ee-lyoon/rhdhpai802-19](https://quay.io/rh-ee-lyoon/rhdhpai802-19) and deployed through GitOps. This application is accessible on port **8501**.